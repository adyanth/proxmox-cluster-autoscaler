module github.com/adyanth/proxmox-cluster-autoscaler

go 1.22.5

require (
	github.com/alexellis/k3sup v0.0.0-20240807144245-b7bb7cb246eb
	github.com/luthermonson/go-proxmox v0.1.0
	google.golang.org/grpc v1.65.0
	k8s.io/api v0.31.0
	k8s.io/apimachinery v0.31.0
	k8s.io/autoscaler/cluster-autoscaler v0.0.0-20240823171014-2caebb93f3cf
...
require (
	...
	k8s.io/kube-scheduler v0.31.0 // indirect
